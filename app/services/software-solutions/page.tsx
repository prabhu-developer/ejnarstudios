...
export const metadata = constructMetadata({
  title: 'Custom Software Solutions & Enterprise RPA Systems Chennai',
  description: 'Tailored enterprise software development, RPA data extraction, automated backend workers, and legacy modernisation solutions.',
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-display font-black text-3xl sm:text-4xl text-cream mb-6">
                Proprietary Software Systems <br />
                <span className="text-gold-gradient">Without Legacy Bloat.</span>
              </h2>
            ...
            <div className="p-8 rounded-2xl bg-dark-secondary/80 border border-primary/20 shadow-2xl space-y-4">
              <h3 className="font-display font-bold text-xl text-cream">
                Software Deliverables & Artifacts
              </h3>
              {service.deliverables.map((deliv, dIdx) => (
                <div key={dIdx} className="p-3.5 rounded-lg bg-dark border border-white/5 flex items-center justify-between text-xs">
                  ...
                  <span className="text-[10px] font-mono text-primary uppercase">Enterprise</span>
                </div>
              ))}
            </div>
          </div>
